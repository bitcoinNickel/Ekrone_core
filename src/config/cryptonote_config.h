...
namespace cryptonote
{
    namespace parameters
    {
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX = 0x3db304;
        ...
        */
        const char GENESIS_COINBASE_TX_HEX[] = "011401ff000183b1de16029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101c36e05d423fffbab89158145939ff6"
                                               "ba52643ff846f0449bce99165f7be1aa58";
    ...
    const char CRYPTONOTE_NAME[] = "ekrone";
...
#ifdef USE_TESTNET
    const int P2P_DEFAULT_PORT = 14090;
    const int RPC_DEFAULT_PORT = 14091;
#else
    ...
    const char LATEST_VERSION_URL[] = "https://github.com/ekrone/ekrone";
    const std::string LICENSE_URL = "https://github.com/ekrone/ekrone/blob/master/LICENSE";
